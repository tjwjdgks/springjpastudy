...
// QueryByExampleExecutor는 query by example 을 위해서 인터페이스 확장
public interface CommentRepository extends MyInterface<Comment,Long> , QueryByExampleExecutor<Comment> {
